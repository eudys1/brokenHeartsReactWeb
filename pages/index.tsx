	...
	return (
		<div className=" ">
			<Head>
				...
				<meta name="description" content="Bienvenido al WebSite de Broken Hearts, aqui podras ver un porfolio de fotografia asi como comprar merchandising de gran calidad." />
				<meta charSet="utf-8"/>
				<link rel="icon" href="/SORA-SOMBRA-BLANCA.png" />
				<meta name="keywords" content="fotografia, broken hearts, tienda broken hearts, tienda, eudys"/>
			</Head>
